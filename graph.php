...
<body style = "background-image: url("https://appsvel.eu/assets/images/medical/background.jpg");">
            ...
            <ul class="navbar-nav">
              ...
              <li class="nav-item">
                <a class="nav-link" href="user.php">
				  ...
				  <h7 style = "position: absolute; right: 1%; top:70%; color: White; " > User: <?php echo htmlspecialchars($_SESSION["username"]); ?></h7>
                  <p>
              ...
              <div class="card-header">
                ...
                <div class="dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    ...
                    <a class="dropdown-item" href="doctordata.php">Change Values</a>
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card  card-tasks">
              <div class="card-header ">
                <h5 class="card-category">Doctor Recommendations</h5>
                  ...
                  <table class="table">
                    <tbody>
                      <tr>
                        ...
                        <td class="text-left">Take pills</td>
                      ...
                      <tr>
                        ...
                        <td class="text-left">Get body temperature</td>
                        <td class="td-actions text-right">
                          <button type="button" rel="tooltip" title="" class="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral" data-original-title="Edit Task">
                            <i class="now-ui-icons ui-2_settings-90"></i>
                          </button>
                      ...
                      <tr>
                        ...
                        <td class="text-left">Perform relaxation
                        </td>
                        <td class="td-actions text-right">
                          <button type="button" rel="tooltip" title="" class="btn btn-info btn-round btn-icon btn-icon-mini btn-neutral" data-original-title="Edit Task">
                            <i class="now-ui-icons ui-2_settings-90"></i>
