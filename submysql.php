...
// v4:  $out_connection = mysql_connect("localhost","sqluser","sssqql") or die ("Could not connect to the server: " . mysql_error());
   $out_connection = mysqli_connect("localhost","root","") or die ("Could not connect to the server: " . mysqli_connect_error());
...
// default dbname can be provided here as 4th parameter
  $my_connection = mysqli_connect("localhost","root","") or die ("Could not connect to the server: " . mysqli_connect_error());
