      ...
      <nav class="navbar navbar-expand-lg navbar-transparent  bg-primary  navbar-absolute">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="#pablo">Patients List</a>
          </div>
...
?>
          ...
          <div class="col-md-12">
            <div class="card card-plain">
              <div class="card-header">
                ...
                <p class="category"> Data obtained via AI Care</p>
              </div>
              <div class="card-body">
                <div class="table-responsive">
	...
	/* Fetch data from databse(select query) */
            ...
            $resbio = $con->query("select * from item where description like  '%$searchstring%'" ) or die(mysqli_error($con));
